/** Filename: SplitAccurate.java
  ...
  *              lists are equal or close to equal quickly.
  **/
...
public class SplitQuick
{
  ...
  /** Description: This method will take in an int array and find the sum of 
    ...
    **/ 
  public int[][] splitQuickly(int[] integerList) throws InvalidInputException{
...
////////////////////////////////////////////////////////////////////////////////////
  ...
  {
    SplitQuick f = new SplitQuick();

    //int intArr[] = {65,31,72,2,57,6,65,50};
    //nt intArr[] = {200, 50,40,60,20,5};
